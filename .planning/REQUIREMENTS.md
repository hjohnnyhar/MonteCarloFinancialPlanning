...
- [ ] **SIM-01**: System runs Monte Carlo simulation with thousands of randomized market-return scenarios against the completed financial profile
- [ ] **SIM-02**: Simulation produces a probability score per financial goal (e.g., "78% chance of funding retirement")
- [ ] **SIM-03**: Simulation produces an overall plan probability score across all goals
